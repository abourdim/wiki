...
- [micro:bit Playground](bit-playground.html) — 8-tab BLE control panel and sensor dashboard for the BBC micro:bit V2: live sensor graphing, servo control, 5 interactive 3D robot models, and a 30+ command firmware protocol. Full EN/FR/AR translation.
- [Micro:bit Remote Builder (rxy)](rxy.html) — Drag-and-drop BLE remote-control builder: design a layout from 12 widget types and it generates matching MakeCode firmware automatically, with one-click flashing over Bluetooth Partial Flashing Service or WebUSB.

## Index

Open [index.html](index.html) for a browsable landing page of all guides.
